 ...
 *         &lt;element name="blockedAmount" type="{http://www.w3.org/2001/XMLSchema}double" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "preAuthorizeResponse")
public class PreAuthorizeResponse {
    ...
    protected Double blockedAmount;
    ...
    /**
     * Recupera il valore della proprietà blockedAmount.
     * 
     * @return
     *     possible object is
     *     {@link Double }
    ...
    /**
     * Imposta il valore della proprietà blockedAmount.
     * 
     * @param value
     *     allowed object is
     *     {@link Double }
     *     
     */
    public void setBlockedAmount(Double value) {
